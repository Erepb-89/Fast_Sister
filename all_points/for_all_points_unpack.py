...
primary_file_name = f'UNPACK_{point_type}_DEBLOCK_TEST.xml'  # Исходный xml файл с шаблоном
...
new_gvl_file_path = f'{point_type}/{controller}_UNPACK_{point_type}_DEBLOCK_gvl.xml'   # Новый файл safety_gvl для загрузки в конфигурацию
